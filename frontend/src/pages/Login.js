...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log("Sending Data:", JSON.stringify(loginData)); // Debugging line
    ...
    try {
      const response = await fetch('http://localhost:8080/api/login', {
        ...
        body: JSON.stringify(loginData), // Convert the form data to JSON
      });
  ...
  return (
    <LoginContainer>
      <LoginBox>
        <LogoImage src={logo} alt="CoinnectX Logo" />
        ...
        <LinkText onClick={handleSignInClick}>Create New Account</LinkText>
      </LoginBox>
    </LoginContainer>
  );
};
